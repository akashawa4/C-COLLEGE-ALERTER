...
public:
    ...
    vector<User> nonTeachingStaff;  // Changed from 'staff' to 'nonTeachingStaff'
    vector<User> admins;
    ...
    void registerUser(const string& username, const string& password, int roleChoice, const string& phoneNumber, const string& staffRole, const string& prn, const string& accessRole) {
        ...
        switch (roleChoice) {
            ...
            case 3: role = "Non-Teaching Staff"; break;  // Updated role to Non-Teaching Staff
        ...
        } else if (role == "Non-Teaching Staff") {  // Updated to Non-Teaching Staff
            nonTeachingStaff.push_back(newUser);
        }
    }
    ...
    void manageData() {
        cout << "\n--- Registered Users ---\n";
        cout << "Students: " << students.size() << "\nTeachers: " << teachers.size() << "\nNon-Teaching Staff: " << nonTeachingStaff.size() << "\nAdmins: " << admins.size() << "\n";
    }
};
...
int main() {
    ...
    while (true) {
        ...
        switch (choice) {
            case 1: role = "Student"; break;
            case 2: role = "Teacher"; break;
            case 3: role = "Non-Teaching Staff"; break;  // Updated to Non-Teaching Staff
        ...
        if (role == "Admin") {
            while (true) {
                ...
                if (choice == 2) {
                    ...
                    } else if (newRoleChoice == 3) {  // Updated to Non-Teaching Staff
                        cout << "Choose Non-Teaching Staff Role:\n1. Driver\n2. Peon\n3. Cleaner\n4. Security\n5. Lab Assistant\n6. Accountant\n7. Librarian\n8. Technician\n9. Clerk\nEnter your choice: ";
                        int staffChoice;
                        cin >> staffChoice;
            ...
            while (true) {
                ...
                if ((role == "Student" && choice == 3) || (role == "Teacher" && choice == 3) || (role == "Non-Teaching Staff" && choice == 10)) {  // Updated condition for Non-Teaching Staff
