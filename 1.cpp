...
public:
    ...
    void registerUser(const string& username, const string& password, int roleChoice, const string& phoneNumber, const string& staffRole, const string& accessRole) {
        if (accessRole != "Admin") {
        ...
        User newUser = {username, password, role, phoneNumber, staffRole};
        ...
        if (role == "Admin") {
            while (true) {
                ...
                if (choice == 2) {
                    ...
                    string newUser, newPass, phone, staffRole = "N/A";
                    int newRoleChoice;
                    ...
                    admin.registerUser(newUser, newPass, newRoleChoice, phone, staffRole, "Admin");
                } else {
